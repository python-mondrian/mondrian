...
setup(
    ...
    description=(
        "Mondrian helps you to configure and use python's logging module once and for "
        "ever."
    ),
    ...
    download_url="https://github.com/python-mondrian/mondrian/archive/{version}.tar.gz".format(
        version=version
    ),
)
